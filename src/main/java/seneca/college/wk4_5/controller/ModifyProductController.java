...
public class ModifyProductController implements Initializable {
    ...
    @Inject
    public ModifyProductController(PartRepository partRepository, ProductRepository productRepository) {
    ...
    private void populateFields() {
        ...
        associatedParts.setAll(productToModify.getAllAssociatedParts());
    }
        ...
        try {
            if (productToModify == null) {
                showAlert(Alert.AlertType.ERROR, "Error",
                        "No product data available to modify. Please close this window and try again.");
                return;
            }
            ...
            associatedParts.forEach(updatedProduct::addAssociatedPart);
            productRepository.replace(productToModify, updatedProduct);
            productToModify = updatedProduct;
